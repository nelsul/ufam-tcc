...
\begin{itemize}
    ...
    \item \textbf{Teleatendimento}: Implementar um módulo de videochamada integrado à plataforma para permitir a realização de sessões de atendimento remoto de forma segura dentro do próprio ambiente do sistema.
\end{itemize}
