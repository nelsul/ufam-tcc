...
{\noindent Trabalho de Conclusão de Curso apresentado ao Instituto de Computação da Universidade Federal do Amazonas como parte dos requisitos necessários para obtenção do grau de Bacharel em Engenharia de Software.} % Engenheira de Software}.
%{\noindent Dissertação apresentada à Universidade Federal do Amazonas, no Programa de Pós-Graduação em Engenharia de Software, para a obtenção do título de Mestre em Ciências.}
%{\noindent Tese apresentada à Universidade Federal do Amazonas, no Programa de Pós-Graduação em Engenharia de Software, para a obtenção do título de Doutor em Ciências.}
\\ \\
\end{minipage}
\end{flushright}
%%%%%%%%%%%%%%%%%%5
...
%{Área de Concentração: Controle e Automação de Software} % para o caso de Dissertação/Tese
\end{minipage}
\\
...
\end{center}
\vspace*{1cm}
{\noindent Trabalho de Conclusão de Curso (TCC) apresentado ao Instituto de Computação da Universidade Federal do Amazonas como parte dos requisitos necessários para obtenção do grau de Bacharel em Engenharia de Software.}
\\[0.25cm]
%{\noindent Área de concentração: Controle e Automação de Software.}\\[0.8cm] % Para dissertação/tese
%\vspace{-.8cm}
