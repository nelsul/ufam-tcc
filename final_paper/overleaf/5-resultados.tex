...
\begin{figure}[htb]
    ...
    \begin{center}
        \includegraphics[width=0.8\textwidth]{Imagens/password-hash.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}
...
Após o preenchimento completo do formulário (Figura \ref{fig:request-complete}), o sistema valida os dados e envia a solicitação.

\begin{figure}[htb]
    \caption{\label{fig:request-complete}Confirmação da Solicitação de Agendamento}
    \begin{center}
        \includegraphics[width=0.6\textwidth]{Imagens/schedule-p3.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}
...
\begin{figure}[htb]
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagens/schedule-p4-email.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}
...
\begin{figure}[htb]
    ...
    \begin{center}
        \includegraphics[width=0.8\textwidth]{Imagens/appointments-02.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

O sistema oferece opções claras para gestão do agendamento (Figura \ref{fig:appointment-actions}), incluindo a possibilidade de confirmar com apenas um clique.

\begin{figure}[htb]
    \caption{\label{fig:appointment-actions}Vincular Estudante ao Agendamento}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{Imagens/appointments-03.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

Ao confirmar, o profissional pode revisar os dados finais antes do envio da notificação ao estudante (Figura \ref{fig:appointment-confirm}).

\begin{figure}[htb]
    \caption{\label{fig:appointment-confirm}Confirmação de Vinculação do Estudante ao Agendamento}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{Imagens/appointments-04.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

O sistema valida os dados e exibe mensagem de sucesso (Figura \ref{fig:appointment-success}), enquanto dispara automaticamente o email de confirmação para o estudante.

\begin{figure}[htb]
    \caption{\label{fig:appointment-success}Seleção do Tipo de Atendimento}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{Imagens/appointments-05.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

O email enviado ao estudante contém todos os detalhes do agendamento confirmado (Figura \ref{fig:appointment-email}), incluindo data, horário e informações sobre o atendimento.

\begin{figure}[htb]
    \caption{\label{fig:appointment-email}Email de Confirmação de Agendamento}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagens/appointments-06.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}
...
\begin{figure}[htb]
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagens/appointments-07.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}
...
Durante a sessão, o profissional tem acesso a ferramentas de formatação de texto (Figura \ref{fig:session-editor}) para organizar melhor suas anotações.

\begin{figure}[htb]
    \caption{\label{fig:session-editor}Prontuário Eletrônico com Editor de Texto Rico}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{Imagens/sessions-02.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

O sistema permite que o profissional registre informações detalhadas (Figura \ref{fig:session-notes}), mantendo um histórico completo de cada atendimento.

\begin{figure}[htb]
    \caption{\label{fig:session-notes}Dados do Prontuário Eletrônico Criptografados}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{Imagens/sessions-03.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

Ao finalizar a sessão, o sistema salva automaticamente todas as informações (Figura \ref{fig:session-save}), aplicando criptografia antes de persistir no banco de dados.

\begin{figure}[htb]
    \caption{\label{fig:session-save}Encerramento da Sessão}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{Imagens/sessions-04.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

O histórico de sessões anteriores pode ser consultado (Figura \ref{fig:session-history}), permitindo ao profissional acompanhar a evolução do estudante ao longo do tempo.

\begin{figure}[htb]
    \caption{\label{fig:session-history}Histórico de Sessões do Estudante}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{Imagens/sessions-05.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

O acesso aos detalhes de sessões passadas (Figura \ref{fig:session-details}) permite uma continuidade efetiva no acompanhamento, com todas as anotações anteriores disponíveis de forma organizada e segura.

\begin{figure}[htb]
    \caption{\label{fig:session-details}Conclusão do Agendamento}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{Imagens/sessions-06.png}
    \end{center}
    \legend{O Autor (2025)}
\end{figure}

Um ponto crucial é a segurança dos dados: todas as anotações salvas são criptografadas antes de serem persistidas no banco de dados, garantindo o sigilo das informações sensíveis dos estudantes.
