...
\section{Metodologia}
A metodologia adotada foi baseada em um modelo de desenvolvimento iterativo e incremental, permitindo a construção do software em ciclos e validações contínuas com a stakeholder (psicóloga do ICOMP).
